...
// Chat / messaging view for the admin panel. Carved out of the
// monolithic Admin.jsx during the admin restructure ferment. Contains
// the conversation list, message thread, composer, profile overlay,
// media viewer, upload overlay, and message/list context menus.
//
// Self-contained: manages its own state, sockets, file uploads, and
// recorder integration. Receives no props by default — Admin.jsx
// only renders it once the admin is authenticated.
//
      ...
      >
        ...
        <aside className="list">
          ...
          <div className="list-inner">
            ...
            {hasMoreChats && filtered().length >= 30 && (
              <div style={{ padding: '12px', textAlign: 'center' }}>
                <button className="btn ghost" onClick={handleLoadMoreChats}>
                  Load more
                </button>
              </div>
            )}
